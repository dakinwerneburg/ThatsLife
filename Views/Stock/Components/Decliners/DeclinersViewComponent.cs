...
namespace ThatsLife.Views.Stock.Components.Decliners
{
    public class DeclinersViewComponent: ViewComponent
    {
        private string _URL;
        private string _IExcloudKey;

        public IConfiguration Configuration { get; }
        public DeclinersViewComponent(IConfiguration configuration)
        {
            Configuration = configuration;
            _IExcloudKey = Configuration["APIs:IExapix"];
            _URL = $"https://cloud.iexapis.com/stable/stock/market/list/losers?token={_IExcloudKey}";
        }
        /// <summary>
